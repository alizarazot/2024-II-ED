...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDeleteIndex = new javax.swing.JButton();
        ...
        btnDeleteIndex.setText("Eliminar por posición");
        btnDeleteIndex.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDeleteIndexActionPerformed(evt);
            }
        });
    ...
    private void btnDeleteIndexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteIndexActionPerformed
        int index = Integer.parseInt(JOptionPane.showInputDialog("Índice a eliminar:"));

        Nodo node = objlista.deleteIndex(index);
        if (node != null) {
            JOptionPane.showMessageDialog(rootPane, String.format("Elemento eliminado: %s", node.getNombre()));
            return;
        }

        JOptionPane.showMessageDialog(rootPane, "No existe un elemento con ese índice.");
    }//GEN-LAST:event_btnDeleteIndexActionPerformed
    ...
    private javax.swing.JButton btnDeleteIndex;
